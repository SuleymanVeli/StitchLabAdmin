...
function ContentRow({ sIndex, cIndex, control, register, remove, getValues, setValue, insert }: any) {
    ...
    const newItem = { type: 'step', text: '', step: cIndex + 1, images: [] };

    return (
        <div className={styles.rowContainer}>
            <div className={styles.insertAction}>
                <Button
                    type="button"
                    variant={'outline'}
                    size='sm' 
                    onClick={() => insert(cIndex, newItem)}                    
                >
                    + Bura sətir əlavə et
                </Button>
            </div>
